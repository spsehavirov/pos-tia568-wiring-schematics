...
\newcommand\WireOrder{1/green, 0/green, 1/orange, 0/blue, 1/blue, 0/orange, 1/brown, 0/brown}
...
\begin{tikzpicture}[
    ...
    \begin{scope}[on background layer]
      \draw node[yshift=-1.5cm, gray!80, fill=gray!3, draw, fit=(pin_1)(pin_2)(pin_3)(pin_4)(pin_5)(pin_6)(pin_7)(pin_8), minimum height=5cm] (connector) {};
      \draw (connector.north) node[yshift=-0.01cm, anchor=south, gray!80, fill=gray!3, draw, minimum height=0.1cm, minimum width=1cm] (tip) {};
    \end{scope}
\end{tikzpicture}
